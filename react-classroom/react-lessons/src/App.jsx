...
function App() {
  ...
  return (
    <div className="App">
      ...
      <AboutMe/>
      <hr />
      <StudentInformation studentName = "Veronica" studentGrade ="A" classSubject ="Magical Might"/>
      <StudentInformation studentName = "Hendrick" classSubject ="Agility"/>
      <StudentInformation studentName = "Sylvando" classSubject ="Charisma"/>
      <hr />
      <Footer/>
    </div>
  );
