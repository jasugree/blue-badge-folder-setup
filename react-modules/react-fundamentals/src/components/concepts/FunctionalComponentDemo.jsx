    ...
    return (
        <Container className="main">
            <Row>
                ...
                <p>Fucntional Components are the primary tool in React to build a small. modular pieve of your page.</p>
                <dl>
                    <dt>Can use state</dt>
                    ...
                    <dd>Older class compenentss use 'this', fucntional components have no ' this object.</dd>
                ...
                <h2>Functional Syntact versus Arrow Function</h2>
                </Col>
            </Row>
            <hr />
            <h2>Challenge</h2>
